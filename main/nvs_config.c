...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_POOL_MODE]                             = {.nvs_key_name = "poolmode",        .type = TYPE_U16,   .default_value = {.u16 = 0},                                           .rest_name = "poolMode",                           .min = 0,  .max = 1},
    [NVS_CONFIG_POOL_BALANCE]                          = {.nvs_key_name = "poolbalance",     .type = TYPE_U16,   .default_value = {.u16 = 50},                                          .rest_name = "poolBalance",                        .min = 1,  .max = 99},
    ...
    [NVS_CONFIG_INVERT_FAN_POLARITY]                   = {.nvs_key_name = "invertfanpol",    .type = TYPE_BOOL},
